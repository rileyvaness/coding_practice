...
Table
World: name, continent, area, gdp, population */
...
/* #3List the name and continent of countries in the continents containing either Argentina or Australia. 
...
SELECT name
FROM world
WHERE gdp > (SELECT MAX(gdp) FROM worl WHERE continent = 'Europe');   
